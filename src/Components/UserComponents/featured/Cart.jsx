...
const Cart = () => {
    ...
    const fetchProducts = async () => {
      const responses = await Promise.all(
        ...
        cartItems?.map(item =>
          axios.get(`https://api.defencesportsworld.com/api/products/${item.productId}`).catch(err=>console.log(err))
        )
      )
  ...
  const res = await axios.post('https://api.defencesportsworld.com/api/payment/create-order', { amount });
  ...
  const options = {
    ...
    handler: async function (response) {
      ...
      await axios.post('https://api.defencesportsworld.com/api/orders', orderData).catch((err)=>{console.log(err); alert('Payment Failed')});
            ...
            <div className="productList">
                ...
                <div className="list">
                    ...
                    <div className="row" key={value._id}>
                        <div className="image"><img src={`https://api.defencesportsworld.com/adminUploads/products/${value.subCategory._id}/${value.images[0].filename}`}/></div>
                        <div className="deats">
