      ...
      <div className="container">
        <div className="content">
          ...
          <div className="slider">
            <div className="vector left" onClick={handlePrev}>
              ...
              >
                {allProducts.map((product, index) => (
                  ...
                  >
                    ...
                    {index === slide && (
                      <>
                        <div className="sliderText">{product.title}</div>
                        <button onClick={() => navigate(`/categories/${product.category}/Magzine`)}>
                          Buy Now
                        </button>
                      </>
                    )}
            ...
            <div className="vector right" onClick={handleNext}>
